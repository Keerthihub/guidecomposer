/*
 * GuideComposer live QA, part 04: ownership after the user edits the document
 *
...
(function () {
    ...
    function owned(doc) {
        ...
        for (var l = 0; l < doc.layers.length; l++) { var gs = doc.layers[l].groupItems;
            for (var g = 0; g < gs.length; g++) { var tags = gs[g].tags, o = null, k = null, ab = null;
                ...
                if (o === "com.keerthi.guidecomposer") out.push({ group: gs[g], kind: k, artboard: ab, nested: gs[g].parent.typename !== "Layer" }); } }
        return out;
    }
    ...
    try_("claim: preview dirties other documents and forces the layer visible", function () {
        ...
        call("generate", { settings: COLS, target: { mode: "active" } });
        var layerA = null;
        for (var i = 0; i < a.layers.length; i++) if (a.layers[i].name === "GuideComposer grids") layerA = a.layers[i];

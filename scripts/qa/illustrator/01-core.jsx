/*
 * GuideComposer live QA, part 01: generate, undo, replace, clear, outputs, artboards, previews, construction
 *
...
(function () {
    ...
    function gridLayer(doc) {
        for (var i = 0; i < doc.layers.length; i++) { if (doc.layers[i].name === "GuideComposer grids") return doc.layers[i]; }
        return null;
    }

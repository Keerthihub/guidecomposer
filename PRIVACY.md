...
GuideComposer is an extension for Adobe Illustrator and Adobe InDesign published by
[PUBLISHER_NAME] ("we").

## What GuideComposer collects

Nothing. GuideComposer does not collect, transmit, sell, or share personal data or
usage data.

- **No network access.** GuideComposer makes no network requests of any kind. It
...
- **No accounts.** GuideComposer never asks for a sign-in, an email address, or a
...
## What GuideComposer stores on your computer

Everything GuideComposer saves stays on your own computer. None of it is readable by
us.
...
- **Your documents** gain a layer named "GuideComposer grids" containing the grids you
  create. Grids carry small tags that identify them as GuideComposer grids, so GuideComposer
...
- **Preset files** are written only when you choose Export presets, to the
  ...
  GuideComposer reads no other file on your computer, and writes nowhere else.
...
GuideComposer is a professional design tool. It is not directed at children and
...
If a future version changes what GuideComposer collects or stores, we will update this

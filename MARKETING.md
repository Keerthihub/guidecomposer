...
Apply a grid to one artboard, all of them, a list like 1–3, 5, or inside the objects you've selected: a card, a panel, a photo frame. Mark content blocks by dragging across the grid.
